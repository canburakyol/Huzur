...
export const STORAGE_KEYS = {
  ...
  AI_FLAGS_CACHE: 'huzur_ai_flags_cache',
  AI_FLAGS_CACHE_AT: 'huzur_ai_flags_cache_at',
  AI_ASSISTANT_SESSION_ID: 'huzur_ai_assistant_session_id',
  AI_ASSISTANT_SESSION_SUMMARY: 'huzur_ai_assistant_session_summary',
  AI_HEALTH_CACHE: 'huzur_ai_health_cache',
  AI_HEALTH_CACHE_AT: 'huzur_ai_health_cache_at',
  AI_INCIDENTS: 'huzur_ai_incidents',
  AI_GLOBAL_RELEASE_STATUS_CACHE: 'huzur_ai_global_release_status_cache',
  AI_GLOBAL_RELEASE_STATUS_CACHE_AT: 'huzur_ai_global_release_status_cache_at',
  ONBOARDING_CONFIG_CACHE: 'huzur_onboarding_config_cache',
  ONBOARDING_CONFIG_CACHE_AT: 'huzur_onboarding_config_cache_at',
  PREMIUM_MOMENTS_CONFIG_CACHE: 'huzur_premium_moments_config_cache',
  PREMIUM_MOMENTS_CONFIG_CACHE_AT: 'huzur_premium_moments_config_cache_at',
  PREMIUM_MOMENT_PENDING: 'huzur_premium_moment_pending',
