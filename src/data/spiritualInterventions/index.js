const SOURCE_LIBRARY = {
  ...
  ahzab_33_56: {
    coreMessage: 'Allah ve melekleri Peygamber\'e salat eder; muminler de salat ve selam getirsin.',
    confidence: 'high',
...
const ACTION_FALLBACK_BY_STATE = {
...
const TIME_REFLECTION_VARIANTS = {
  any: {
    afternoon: [
...
const STATE_SECOND_SENTENCE_VARIANTS = {
  low_iman_streak: [
  ...
  steady: [
    'Dengedeyken kurulan bu kucuk temas, sebat duygusunu korur ve sukru derinlestirir; istersen bunu {action} ile pekistirebilirsin.',
...
const TIME_ORDER = ['morning', 'noon', 'afternoon', 'evening', 'night', 'late_night'];
const USER_STATE_ORDER = ['stressed', 'steady', 'low_iman_streak'];

const resolveSuggestedAction = ({ source, timeOfDay, userState }) => {
...
const buildGreeting = ({ dayOfWeek, timeOfDay, userState, variantIndex }) => {
...
const buildReflection = ({ dayOfWeek, timeOfDay, userState, variantIndex, suggestedAction }) => {
