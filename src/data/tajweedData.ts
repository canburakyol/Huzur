...
export const tajweedData: TajweedRule[] = [
  {
    id: 'med_tabii',
...
export const getTajweedRule = (id: string): TajweedRule | undefined => tajweedData.find(r => r.id === id);
export const getRulesByLevel = (level: string): TajweedRule[] => tajweedData.filter(r => r.level === level);
