...
export const SEERAH_PERIODS: SeerahPeriod[] = [
...
export const SEERAH_EVENTS: SeerahEvent[] = [
  ...
  },
  {
    ...
    title: 'Hendek Savaşı',
    location: 'Medine',
    description: '10.000 kişilik düşman koalisyonuna karşı Selman-ı Farisi\'nin önerisiyle Medine çevresine hendek kazıldı. Düşman bir ay kuşatma yaptı ama aşamadı. Soğuk ve fırtına ile dağıldılar. İslam\'ın stratejik zekası ortaya çıktı.',
    icon: '🛡️',
    importance: 'critical'
  },
  {
  ...
  },
  {
    ...
    title: 'Vefat',
    location: 'Medine',
    description: 'Peygamberimiz 63 yaşında, Rebiulevvel ayının 12\'sinde Pazartesi günü Hz. Aişe\'nin evinde vefat etti. Hz. Ebubekir "Kim Muhammed\'e tapıyorsa bilsin ki O öldü, kim Allah\'a tapıyorsa O daima diridir" dedi. Mescid-i Nebevi\'ye defnedildi.',
    icon: '🕌',
    importance: 'critical'
  }
];
