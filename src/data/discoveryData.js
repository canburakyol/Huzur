/**
 * Günlük Keşif Kartları Veri Dosyası
 * Her gün kullanıcıya farklı içerik kartları sunar
 * Kartlar: Günün Ayeti, Günün Hadisi, Günün Esması, Günün Duası, Günün Hikmeti, Biliyor muydun?
 */
...
/**
 * Deterministic daily card selection based on date
 * Returns 3 unique cards each day (one from different types)
 */
export function getDailyDiscoveryCards() {
  ...
  // Select 3 cards from 3 different types, rotating daily
  for (let i = 0; i < 3; i++) {
