...
export interface ReligiousTerm {
  id: string;
  name: string;
  icon: string;
  description: string;
...
export interface PrayerInvalidator {
  id: number;
  text: string;
  icon: string;
}
...
export const RELIGIOUS_TERMS: ReligiousTerm[] = [
  {
    id: 'farz',
    name: 'Farz',
    icon: '⭐',
...
export const PRAYER_INVALIDATORS: PrayerInvalidator[] = [
