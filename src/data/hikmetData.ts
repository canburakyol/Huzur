export interface HikmetCategory {
  id: string;
  title: string;
  icon: string;
  description: string;
...
export const HIKMET_CATEGORIES: HikmetCategory[] = [
...
export const HIKMETLER: Hikmet[] = [
  ...
  { id: 31, category: 'hadis', text: 'hikmet.items.31.text', source: 'hikmet.items.31.source', reference: 'hikmet.items.31.ref' },
  { id: 32, category: 'hadis', text: 'hikmet.items.32.text', source: 'hikmet.items.32.source', reference: 'hikmet.items.32.ref' },
  { id: 33, category: 'hadis', text: 'hikmet.items.33.text', source: 'hikmet.items.33.source', reference: 'hikmet.items.33.ref' },
  { id: 34, category: 'hadis', text: 'hikmet.items.34.text', source: 'hikmet.items.34.source', reference: 'hikmet.items.34.ref' },
  { id: 35, category: 'hadis', text: 'hikmet.items.35.text', source: 'hikmet.items.35.source', reference: 'hikmet.items.35.ref' },
  { id: 36, category: 'hadis', text: 'hikmet.items.36.text', source: 'hikmet.items.36.source', reference: 'hikmet.items.36.ref' },
  { id: 37, category: 'hadis', text: 'hikmet.items.37.text', source: 'hikmet.items.37.source', reference: 'hikmet.items.37.ref' },
  { id: 38, category: 'hadis', text: 'hikmet.items.38.text', source: 'hikmet.items.38.source', reference: 'hikmet.items.38.ref' },
  { id: 40, category: 'hadis', text: 'hikmet.items.40.text', source: 'hikmet.items.40.source', reference: 'hikmet.items.40.ref' },
  { id: 41, category: 'hadis', text: 'hikmet.items.41.text', source: 'hikmet.items.41.source', reference: 'hikmet.items.41.ref' },
  { id: 42, category: 'hadis', text: 'hikmet.items.42.text', source: 'hikmet.items.42.source', reference: 'hikmet.items.42.ref' },
  { id: 50, category: 'hadis', text: 'hikmet.items.50.text', source: 'hikmet.items.50.source', reference: 'hikmet.items.50.ref' },
  { id: 51, category: 'hadis', text: 'hikmet.items.51.text', source: 'hikmet.items.51.source', reference: 'hikmet.items.51.ref' },
  { id: 52, category: 'hadis', text: 'hikmet.items.52.text', source: 'hikmet.items.52.source', reference: 'hikmet.items.52.ref' },
  { id: 57, category: 'hadis', text: 'hikmet.items.57.text', source: 'hikmet.items.57.source', reference: 'hikmet.items.57.ref' },
  { id: 58, category: 'hadis', text: 'hikmet.items.58.text', source: 'hikmet.items.58.source', reference: 'hikmet.items.58.ref' },
  ...
  { id: 39, category: 'alim', text: 'hikmet.items.39.text', source: 'hikmet.items.39.source', reference: 'hikmet.items.39.ref' },
  { id: 43, category: 'alim', text: 'hikmet.items.43.text', source: 'hikmet.items.43.source', reference: 'hikmet.items.43.ref' },
  { id: 44, category: 'alim', text: 'hikmet.items.44.text', source: 'hikmet.items.44.source', reference: 'hikmet.items.44.ref' },
  { id: 45, category: 'alim', text: 'hikmet.items.45.text', source: 'hikmet.items.45.source', reference: 'hikmet.items.45.ref' },
  { id: 46, category: 'alim', text: 'hikmet.items.46.text', source: 'hikmet.items.46.source', reference: 'hikmet.items.46.ref' },
  { id: 47, category: 'alim', text: 'hikmet.items.47.text', source: 'hikmet.items.47.source', reference: 'hikmet.items.47.ref' },
  { id: 48, category: 'alim', text: 'hikmet.items.48.text', source: 'hikmet.items.48.source', reference: 'hikmet.items.48.ref' },
  { id: 49, category: 'alim', text: 'hikmet.items.49.text', source: 'hikmet.items.49.source', reference: 'hikmet.items.49.ref' },
  { id: 53, category: 'alim', text: 'hikmet.items.53.text', source: 'hikmet.items.53.source', reference: 'hikmet.items.53.ref' },
  { id: 54, category: 'alim', text: 'hikmet.items.54.text', source: 'hikmet.items.54.source', reference: 'hikmet.items.54.ref' },
  { id: 55, category: 'alim', text: 'hikmet.items.55.text', source: 'hikmet.items.55.source', reference: 'hikmet.items.55.ref' },
  { id: 56, category: 'alim', text: 'hikmet.items.56.text', source: 'hikmet.items.56.source', reference: 'hikmet.items.56.ref' },
  ...
  { id: 59, category: 'ayet', text: 'hikmet.items.59.text', source: 'hikmet.items.59.source', reference: 'hikmet.items.59.ref' },
  { id: 60, category: 'ayet', text: 'hikmet.items.60.text', source: 'hikmet.items.60.source', reference: 'hikmet.items.60.ref' }
];

export const getRandomHikmet = (): Hikmet => {
  return HIKMETLER[Math.floor(Math.random() * HIKMETLER.length)];
};

export const getHikmetByCategory = (categoryId: string): Hikmet[] => {
  return HIKMETLER.filter(h => h.category === categoryId);
};

export const getDailyHikmet = (): Hikmet => {
