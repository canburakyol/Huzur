export interface TespihatSection {
  id: string;
  title: string;
  subtitle?: string;
  icon?: string;
...
export const TESPIHAT_SECTIONS: TespihatSection[] = [
  {
    id: 'istigfar',
    title: 'İstiğfar',
    subtitle: '3 defa',
...
export const TEVHID: TevhidEntry = {
  id: 'tevhid',
  title: 'Tevhid',
...
export const NAMAZSONRASI_DUALAR: Dua[] = [
  {
    id: 'rabbena1',
    title: 'Rabbenâ Âtinâ',
    arabic: 'رَبَّنَا آتِنَا فِي الدُّنْيَا حَسَنَةً وَفِي الْآخِرَةِ حَسَنَةً وَقِنَا عَذَابَ النَّارِ',
    latin: 'Rabbenâ âtinâ fid-dünyâ haseneten ve fil-âhireti haseneten ve kınâ azâbennâr.',
...
export const TESPIHAT_ORDER: string[] = [
  'istigfar',
  'entes-selam',
  'salavat',
  'subhanallahi',
