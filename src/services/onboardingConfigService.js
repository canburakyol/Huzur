...
export const getOnboardingConfig = async ({ forceRefresh = false } = {}) => {
  ...
  try {
    const snapshot = await getDoc(doc(db, 'config', 'onboardingExperience'));
