...
export const logAppOpen = (source, metadata) => analyticsService.logAppOpen(source, metadata);
...
export const logFirstActivationFeatureOpened = (feature, source) => analyticsService.logFirstActivationFeatureOpened(feature, source);
