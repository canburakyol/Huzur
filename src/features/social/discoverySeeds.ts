...
export const HATIM_DISCOVERY_SEEDS: HatimDiscoverySeed[] = [
  {
    id: 'seed-hatim-sabir',
...
export const DUA_DISCOVERY_SEEDS: DuaDiscoverySeed[] = [
  {
    id: 'seed-dua-sehri',
...
export const FAMILY_DISCOVERY_SEEDS: FamilyDiscoverySeed[] = [
  {
    id: 'seed-family-dua',
