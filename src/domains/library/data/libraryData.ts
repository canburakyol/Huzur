...
interface LibraryCategory {
  ...
  title: string;
  icon: string;
  data: Book[] | ReligiousText[] | EducationItem[] | Reference[] | AudioCategory[] | VideoCategory[] | FaqCategory[];
  isPro?: boolean;
}
...
Hilafeti döneminde (634-644) Kudüs, Mısır, İran, Suriye fethedildi. Adaletiyle meşhurdur. Geceleri halkın arasına kılık değiştirip çıkar, sorunlarını dinlerdi. Divan teşkilatını kurdu, maaş sistemi başlattı, Hicri takvimi başlattı. 644'te namaz kılırken bir Mecusi köle tarafından hançerlenerek şehit edildi.` },
            {
...
İlk Müslüman olan çocuktur (10 yaşında). Hicret gecesi Hz. Muhammed'in yatağına yatarak onu korudu. Hz. Fatıma ile evlendi, Hasan ve Hüseyin'in babasıdır. Cesareti ve kahramanlığıyla tanınır. Hayber'de kale kapısını söküp kalkan olarak kullandı.
...
export const RELIGIOUS_TEXTS: ReligiousText[] = [
    {
        id: 'kirk-hadis',
        title: 'Kırk Hadis',
        icon: '📜',
...
export const AUDIO: AudioCategory[] = [
    {
        id: 'hatim',
        title: 'Hatim Setleri',
        icon: '🎧',
...
export const VIDEO: VideoCategory[] = [
    {
        id: 'tecvid-dersleri',
