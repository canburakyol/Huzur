...
const Imsakiye = ({ onClose, locationName }) => {
    ...
    const country = t('countries.turkey', 'Turkey');
        ...
        const calculateMonthlyPrayerTimes = () => {
            ...
            try {
                ...
                for (let day = 1; day <= daysInMonth; day++) {
                    ...
                    if (times) {
                        monthData.push({
                            date: date.toLocaleDateString(i18n.language === 'tr' ? 'tr-TR' : i18n.language === 'id' ? 'id-ID' : 'en-US'),
                ...
                setError(t('imsakiye.errorCalculate', 'Namaz saatleri hesaplanamadı. Lütfen tekrar deneyin.'));
            } finally {
                setLoading(false);
            }
        };
                    ...
                    <table style={{ 
                        ...
                        <thead>
                            <tr style={{ 
                                ...
                                <th style={{ padding: '12px 6px', textAlign: 'left' }}>{t('common.day', 'Gün')}</th>
