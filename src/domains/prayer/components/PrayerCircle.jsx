...
const MOCK_REQUESTS = [
  { id: 1, user: 'Ahmet Y.', textKey: 'prayerCircle.mock.work', text: 'Hayırlı bir iş için dua bekliyorum.', count: 12, prayed: false },
  { id: 2, user: 'Fatma K.', textKey: 'prayerCircle.mock.health', text: 'Hastamız için şifa duası eder misiniz?', count: 45, prayed: false },
  { id: 3, user: 'Mehmet S.', textKey: 'prayerCircle.mock.exam', text: 'Sınavlarımda başarı için dua istiyorum.', count: 8, prayed: false },
  { id: 4, user: 'Ayşe D.', textKey: 'prayerCircle.mock.family', text: 'Aile huzuru için dualarınızı bekliyorum.', count: 23, prayed: false }
];
        ...
        {requests.map((req, index) => (
          <div key={req.id} className="settings-card" style={{ 
            ...
            <p style={{ margin: '0 0 16px 0', fontSize: '0.95rem', color: 'var(--nav-text)', fontWeight: '600', lineHeight: '1.6' }}>
              {req.textKey ? t(req.textKey, req.text) : req.text}
            </p>
