    ...
    const shareImage = async (image) => {
        ...
        try {
            ...
            if (Capacitor.isNativePlatform()) {
                ...
                showToast(t('multimedia.shareCopied', 'Paylaşım metni kopyalandı!'), 'success');
            }
        } catch (err) {
    ...
    const downloadImage = async (image) => {
        try {
            ...
            if (image.url) {
                ...
                showToast(t('multimedia.downloadHint', 'Görsel yeni sekmede açılacak. Sağ tıklayıp "Resmi Kaydet" seçeneğini kullanabilirsiniz.'), 'info');
            }
        } finally {
