      ...
      <div className="settings-card reveal-stagger" style={{ 
        ...
        <div style={{ textAlign: 'center' }}>
          ...
          <h2 style={{ 
            ...
            {t('streakProtection.title', 'Manevi Ritim Dengesi')}
          </h2>
          ...
          <p style={{ 
            ...
            {t('streakProtection.description', {
              ...
              defaultValue: 'Dün ara verdiğiniz için {{count}} günlük {{category}} manevi ritminiz azalma eğiliminde. Niyetlerinizi tazelemek ve ritmi korumak için dondurma hakkı kullanabilirsiniz.'
            })}
          </p>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            ...
            >
              ...
              {t('streakProtection.applyAndProtect', 'Dengele ve Ritmi Koru')}
            </button>
            ...
            >
              {t('streakProtection.cancelAndReset', 'Devam Et (Ritmi Akışına Bırak)')}
            </button>
          </div>
        </div>
      </div>
