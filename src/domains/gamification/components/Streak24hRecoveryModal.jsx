...
const Streak24hRecoveryModal = ({
  ...
  const primaryLabel = useMemo(() => (
    requiresRewardedAd
      ? t('streak24h.rewardedAction', 'Reklam İzle ve Ritmi Dengele')
      : t('streak24h.recoverAction', 'Ritmi Dengele')
  ...
  const handlePrimaryAction = async () => {
    ...
    try {
      if (requiresRewardedAd && typeof onWatchRewardedRecovery === 'function') {
        ...
        if (!result?.success) {
          setRewardError(
            result?.error || t('streak24h.rewardedError', 'Ödüllü reklam şu an açılamadı. Lütfen tekrar dene.')
          );
        }
        return;
      }
      ...
      <div className="settings-card reveal-stagger" style={{
        ...
        <div style={{ textAlign: 'center' }}>
          ...
          <h2 style={{
            ...
            {t('streak24h.title', 'Manevi Ritim Telafisi')}
          </h2>
          ...
          <p style={{
            ...
            {t('streak24h.description', {
              ...
              defaultValue: '{{category}} ritminizde küçük bir boşluk oluştu. Niyetinizi tazeleyerek ve telafi ederek kaldığınız yerden huzurla devam edebilirsiniz.'
            })}
          </p>
          ...
          {requiresRewardedAd && (
            <p style={{
              ...
              {t(
                ...
                'Bu dengeleme hakkı reklam tamamlandığında aktif olur.'
              )}
            </p>
          )}
          ...
          <div style={{
            ...
            <span style={{ fontSize: '0.8rem', fontWeight: '800', color: 'var(--nav-text)' }}>
              {t('streak24h.deadline', {
                ...
                defaultValue: 'Kalan dengeleme süresi: {{value}}'
              })}
            </span>
          </div>
          ...
          <div style={{ display: 'flex', gap: '12px' }}>
            ...
            >
              ...
              {isSubmitting
                ? t('streak24h.loadingAction', 'Hazırlanıyor...')
                : primaryLabel}
            </button>
