...
file_path = 'public/locales/tr/translation.json'
...
mood = {
  ...
  "subtitle": "Ruh haline en uygun ayeti senin için seçelim.",
  "loading": "Senin için en uygun ayet araştırılıyor...",
  "ai_badge": "AI Destekli",
  "error_busy": "Şu anda servis yoğun. Lütfen tekrar deneyin.",
  "retry": "Tekrar Dene",
  "ai_footer": "Gemini AI tarafından hazırlandı",
  "another_mood": "Başka Bir Ruh Hali",
  "error_api": "API hatası",
  "error_empty": "Boş yanıt"
}
